...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "collected.monopoly";
	}
}
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$isWizardInstalled = COption::GetOptionString("collected.monopoly", "wizard_installed", "N", $siteID) == "Y";

		if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		$wizard->SetDefaultVars(Array(
			"siteLogo" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/monopoly/site/templates/monop/img/logo.png"),
			"siteLogoRetina" => file_exists(WIZARD_SITE_PATH."include/logo_retina.png") ? WIZARD_SITE_DIR."include/logo_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/monopoly/site/templates/monop/img/logo.png"),
			//"siteLogoMobile" => file_exists(WIZARD_SITE_PATH."include/logo_mobile.png") ? WIZARD_SITE_DIR."include/logo_mobile.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/monopoly/site/templates/monop/themes/".$themeID."/images/logo_mobile.png"),
			//"siteLogoMobileRetina" => file_exists(WIZARD_SITE_PATH."include/logo_mobile_retina.png") ? WIZARD_SITE_DIR."include/logo_mobile_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/monopoly/site/templates/monop/themes/".$themeID."/images/logo_mobile_retina.png")
		));
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("collected.monopoly", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"siteMetaDescription" => GetMessage("wiz_site_desc"),
				"siteMetaKeywords" => GetMessage("wiz_keywords"),
				//"installEshopApp" => COption::GetOptionString("collected.monopoly", "installEshopApp", "Y", $siteID),
			)
		);
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("collected.monopoly", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("collected.monopoly", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("collected.monopoly", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("collected.monopoly", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("collected.monopoly", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				//"shopINN" => COption::GetOptionString("collected.monopoly", "shopINN", "1234567890", $siteID),
				//"shopKPP" => COption::GetOptionString("collected.monopoly", "shopKPP", "123456789", $siteID),
				// "shopNS" => COption::GetOptionString("collected.monopoly", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				// "shopBANK" => COption::GetOptionString("collected.monopoly", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				// "shopBANKREKV" => COption::GetOptionString("collected.monopoly", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				// "shopKS" => COption::GetOptionString("collected.monopoly", "shopKS", "30101 810 4 0000 0000225", $siteID),
				// "siteStamp" => COption::GetOptionString("collected.monopoly", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("collected.monopoly", "shopCompany_ua", "", $siteID),
				// "shopOfName_ua" => COption::GetOptionString("collected.monopoly", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				// "shopLocation_ua" => COption::GetOptionString("collected.monopoly", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				// "shopAdr_ua" => COption::GetOptionString("collected.monopoly", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				// "shopEGRPU_ua" =>  COption::GetOptionString("collected.monopoly", "shopEGRPU_ua", "", $siteID),
				// "shopINN_ua" =>  COption::GetOptionString("collected.monopoly", "shopINN_ua", "", $siteID),
				// "shopNDS_ua" =>  COption::GetOptionString("collected.monopoly", "shopNDS_ua", "", $siteID),
				// "shopNS_ua" =>  COption::GetOptionString("collected.monopoly", "shopNS_ua", "", $siteID),
				// "shopBank_ua" =>  COption::GetOptionString("collected.monopoly", "shopBank_ua", "", $siteID),
				// "shopMFO_ua" =>  COption::GetOptionString("collected.monopoly", "shopMFO_ua", "", $siteID),
				// "shopPlace_ua" =>  COption::GetOptionString("collected.monopoly", "shopPlace_ua", "", $siteID),
				// "shopFIO_ua" =>  COption::GetOptionString("collected.monopoly", "shopFIO_ua", "", $siteID),
				// "shopTax_ua" =>  COption::GetOptionString("collected.monopoly", "shopTax_ua", "", $siteID),

				// "installPriceBASE" => COption::GetOptionString("collected.monopoly", "installPriceBASE", "Y", $siteID),
			)
		);
	}
...
class FinishStep extends CFinishWizardStep
{
	...
	//	$this->content .= "<br clear=\"all\"><a href=\"/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&site_id=".$siteID."&wizardName=collected:monopoly.mobile&".bitrix_sessid_get()."\" class=\"button-next\"><span id=\"next-button-caption\">".GetMessage("wizard_store_mobile")."</span></a><br>";
