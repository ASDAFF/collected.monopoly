...
(function ($, window) {
    "use strict";
    var pluginName = "collectedBanners",
    ...
    * @constructor
    **/
    function CollectedBanners(element, options) {
        this.$element = $(element);
        this.options = $.extend(defaultOptions, options);
        this.adapters = $.collectedBanners.adapters;
        this.sliderAdapter = null;
        this.init();
        this.listenEvents();
    }
    $.extend(CollectedBanners.prototype, {
        init: function () {
            var base = this;
    ...
    $.fn[pluginName] = function (options) {
        return this.each(function () {
            if (!$.data(this, "plugin_" + pluginName)) {
                $.data(this, "plugin_" + pluginName, new CollectedBanners(this, options));
            }
        });
    };
}(jQuery, window));
...
(function ($) {
    ...
    $.collectedBanners.adapters = $.collectedBanners.adapters || {};
    var defaultOptions = {};
    /**
    * @constructor
    **/
    ...
    $.collectedBanners.adapters.owlAdapter = OwlAdapter;
}(jQuery));
/*global jQuery*/
/**
...
(function ($) {
    ...
    **/
    ...
    $.collectedBanners.adapters.slickAdapter = SlickAdapter;
}(jQuery));
