...
$useSorter = false;
if( $arParams['RSMONOPOLY_SHOW_SORTER']=='Y' && \Bitrix\Main\Loader::includeModule("collected.developkit") ) {
	$useSorter = true;
}
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COLLECT_CHOSE_TEMPLATES_SHOW" => $arParams['RSMONOPOLY_SORTER_SHOW_TEMPLATE'],
		"COLLECT_SORT_BY_SHOW" => $arParams['RSMONOPOLY_SORTER_SHOW_SORTING'],
		"COLLECT_SHORT_SORTER" => "N",
		"COLLECT_OUTPUT_OF_SHOW" => $arParams['RSMONOPOLY_SORTER_SHOW_PAGE_COUNT'],
		"COLLECT_CNT_TEMPLATES" => "3",
		"COLLECT_DEFAULT_TEMPLATE" => $arParams['RSMONOPOLY_SORTER_TEMPLATE_DEFAULT'],
		"COLLECT_SORT_BY_NAME" => array("sort", "name", "PROPERTY_PRICE"),
		"COLLECT_SORT_BY_DEFAULT" => "sort_asc",
		"COLLECT_OUTPUT_OF" => array("5", "10", "15", "20", ""),
		"COLLECT_OUTPUT_OF_DEFAULT" => "20",
		"COLLECT_OUTPUT_OF_SHOW_ALL" => "N",
		"COLLECT_CNT_TEMPLATES_0" => "",
		"COLLECT_CNT_TEMPLATES_NAME_0" => "showcase",
		"COLLECT_CNT_TEMPLATES_1" => "",
		"COLLECT_CNT_TEMPLATES_NAME_1" => "list",
		"COLLECT_CNT_TEMPLATES_2" => "",
		"COLLECT_CNT_TEMPLATES_NAME_2" => "list_little",
...
?></div><?
	...
	?><?$intSectionID = $APPLICATION->IncludeComponent(
		...
		array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
			"ELEMENT_SORT_FIELD" => ( $useSorter ? $collectCSortType : $arParams["ELEMENT_SORT_FIELD"] ),
			"ELEMENT_SORT_ORDER" => ( $useSorter ? $collectCSortToo : $arParams["ELEMENT_SORT_ORDER"] ),
			...
			"PAGE_ELEMENT_COUNT" => ( $useSorter ? $collectCOutput : $arParams["PAGE_ELEMENT_COUNT"] ),
			...
			"RSMONOPOLY_TEMPLATE" => $collectCTemplate,
