...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_perspective_".WIZARD_SITE_ID;
		$iblockType = "projects";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."projects/", Array("PERSPECTIVE_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/projects/perspective-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_perspective_".WIZARD_SITE_ID;
$iblockType = "projects";
...
//WizardServices::IncludeServiceLang("perspective.php", $lang);
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_PERSPECTIVE_10").'--;--', ));
