...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_3d_design_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."services/", Array("3D_DESIGN_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/services/3d_design-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_3d_design_".WIZARD_SITE_ID;
$iblockType = "services";
...
//WizardServices::IncludeServiceLang("3d_design.php", $lang);
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_3D_DESIGN_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_3D_DESIGN_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_3D_DESIGN_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_3D_DESIGN_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_3D_DESIGN_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_3D_DESIGN_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_3D_DESIGN_10").'--;--', ));
