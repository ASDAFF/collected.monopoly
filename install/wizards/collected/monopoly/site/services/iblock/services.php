...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_services_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		if ($arIBlock = $rsIBlock->Fetch())
		{
			...
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("SERVICES_IBLOCK_ID" => $iblockID));
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."services/", Array("SERVICES_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/services/services-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_services_".WIZARD_SITE_ID;
$iblockType = "services";
...
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_SERVICES_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_SERVICES_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_SERVICES_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_SERVICES_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_SERVICES_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_SERVICES_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_SERVICES_10").'--;--', ));
