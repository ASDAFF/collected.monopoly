...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_press_about_us_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("PRESS_ABOUT_US_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/services/press_about_us-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_press_about_us_".WIZARD_SITE_ID;
$iblockType = "services";
...
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_PRESS_ABOUT_US_10").'--;--', ));
