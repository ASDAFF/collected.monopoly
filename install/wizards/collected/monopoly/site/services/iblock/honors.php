...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_honors_".WIZARD_SITE_ID;
		$iblockType = "company";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("HONORS_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/company/honors-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_honors_".WIZARD_SITE_ID;
$iblockType = "company";
...
//WizardServices::IncludeServiceLang("honors.php", $lang);
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_HONORS_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_HONORS_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_HONORS_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_HONORS_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_HONORS_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_HONORS_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_HONORS_10").'--;--', ));
