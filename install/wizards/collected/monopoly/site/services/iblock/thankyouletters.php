...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_thankyouletters_".WIZARD_SITE_ID;
		$iblockType = "company";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("THANKYOULETTERS_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/company/thankyouletters-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_thankyouletters_".WIZARD_SITE_ID;
$iblockType = "company";
...
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_THANKYOULETTERS_10").'--;--', ));
