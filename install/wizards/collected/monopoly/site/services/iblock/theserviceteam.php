...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_theserviceteam_".WIZARD_SITE_ID;
		$iblockType = "company";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("THESERVICETEAM_IBLOCK_ID" => $iblockID));
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("THESERVICETEAM_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/company/theserviceteam-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_theserviceteam_".WIZARD_SITE_ID;
$iblockType = "company";
...
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_THESERVICETEAM_10").'--;--', ));
