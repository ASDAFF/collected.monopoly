...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_leadership_".WIZARD_SITE_ID;
		$iblockType = "company";
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/", Array("LEADERSHIP_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/company/leadership-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_leadership_".WIZARD_SITE_ID;
$iblockType = "company";
...
//WizardServices::IncludeServiceLang("leadership.php", $lang);
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_LEADERSHIP_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_LEADERSHIP_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_LEADERSHIP_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_LEADERSHIP_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_LEADERSHIP_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_LEADERSHIP_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_LEADERSHIP_10").'--;--', ));
