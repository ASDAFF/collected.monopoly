...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "monopoly_vacancies_".WIZARD_SITE_ID;
		$iblockType = "company";
...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/company/vacancies-'.LANGUAGE_ID.'.xml';
$iblockCode = "monopoly_vacancies_".WIZARD_SITE_ID;
$iblockType = "company";
...
//CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_VACANCIES_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_VACANCIES_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_VACANCIES_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_VACANCIES_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_VACANCIES_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_VACANCIES_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_VACANCIES_10").'--;--', ));
