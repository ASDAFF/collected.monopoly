...
if(COption::GetOptionString("collected.monopoly", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("collected.monopoly", "template_converted", "Y", "", WIZARD_SITE_ID);
}
elseif (COption::GetOptionString("collected.monopoly", "template_converted", "N", WIZARD_SITE_ID) == "N")
{
	CopyDirFiles(
...
// #COLLECTED_COPYRIGHT#
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."/footer.php", array('COLLECTED_COPYRIGHT' => GetMessage('COLLECTED_COPYRIGHT')));
